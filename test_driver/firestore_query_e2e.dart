  ...
  group('$Query', () {
    ...
    group('collectionGroup()', () {
      test('returns a data via a sub-collection', () async {
        ...
        await collection.doc('doc1')
          .set(
            <String, dynamic>{'foo': 1});
        await collection.doc('doc2')
          .set(
    ...
    group('Query.get()', () {
      test('returns a [QuerySnapshot]', () async {
        ...
        final QuerySnapshot<Map<String, dynamic>> qs = await collection.get();
    ...
    group('Query.snapshots()', () {
      ...
      test('listens to a multiple changes response', () async {
        ...
        final StreamSubscription subscription = stream.listen(expectAsync1(
            (snapshot) {
          call++;
          if (call == 1) {
            expect(snapshot.docs.length, equals(1));
        ...
        await collection.doc('doc1')
            .set(<String, dynamic>{'bar': 'baz'});
        await collection.doc('doc1').delete();
        await collection.doc('doc2')
            .set(<String, dynamic>{'foo': 'bar'});
    ...
    group('Query.endAt{Document}()', () {
      ...
      test('endAtDocument() ends at a document field value', () async {
        ...
        final DocumentSnapshot endAtSnapshot = await collection.doc('doc2').get();
      ...
      test('endAtDocument() ends at a document', () async {
        ...
        final DocumentSnapshot endAtSnapshot = await collection.doc('doc3').get();
    ...
    group('Query.startAt{Document}()', () {
      ...
      test('starts at field paths', () async {
        ...
        final QuerySnapshot<Map<String, dynamic>> snapshot2 = await collection
      ...
      test('startAtDocument() starts at a document field value', () async {
        ...
        final DocumentSnapshot startAtSnapshot = await collection.doc('doc2').get();
      ...
      test('startAtDocument() starts at a document', () async {
        ...
        final DocumentSnapshot startAtSnapshot = await collection.doc('doc3').get();
    ...
    group('Query.endBefore{Document}()', () {
      ...
      test('endbeforeDocument() ends before a document field value', () async {
        ...
        final DocumentSnapshot endAtSnapshot = await collection.doc('doc1').get();
      ...
      test('endBeforeDocument() ends before a document', () async {
        ...
        final DocumentSnapshot endAtSnapshot = await collection.doc('doc4').get();
    ...
    group('Query.startAt/endAt', () {
      ...
      test('starts a document and ends before document', () async {
        ...
        final DocumentSnapshot startAtSnapshot = await collection.doc('doc2').get();
        final DocumentSnapshot endBeforeSnapshot = await collection.doc('doc4').get();
    ...
    group('Query.where()', () {
      test('returns with equal checks', () async {
        ...
        final int rand = Random().nextInt(9999);
      ...
      test('returns with array-contains-any filter', () async {
        ...
        final QuerySnapshot<Map<String, dynamic>> snapshot = await collection.where(
            'category',
      ...
      test('returns where FieldPath', () async {
        ...
        final FieldPath fieldPath = FieldPath(
          const ['nested', 'foo.bar@gmail.com']);
      ...
      test('returns results using FieldPath.documentId', () async {
        ...
        final DocumentReference<Map<String, dynamic>> docRef = await collection.add(
          <String, dynamic>{
            'foo': 'bar',
          });
