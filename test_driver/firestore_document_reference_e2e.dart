...
void runDocumentReferenceTests() {
  group('$DocumentReference', () {
    ...
    Future<DocumentReference<Map<String, dynamic>>> initializeTest(String path) async {
    ...
    group('DocumentReference.snapshots()', () {
      ...
      test('listens to a multiple changes response', () async {
        ...
        await Future.delayed(
            const Duration(seconds: 1), () => null); // allow stream to return a noop-doc
        await document.set(
    ...
    group('DocumentReference.delete()', () {
      test('delete() deletes a document', () async {
        ...
        expect(snapshot.exists, isTrue);
        await document.delete();
        final DocumentSnapshot<Map<String, dynamic>> snapshot2 = await document.get();
    ...
    group('DocumentReference.set()', () {
      ...
      test('set() merges fields', () async {
        ...
        final Map<String, dynamic> dataToSet = <String, dynamic>{
