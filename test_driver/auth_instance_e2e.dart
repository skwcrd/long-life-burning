  ...
  group('FirebaseAuth.instance', () {
    Future<void> commonSuccessCallback(UserCredential credential) async {
      ...
      expect(
        ...
        isInstanceOf<Object>());
      expect(
        additionalUserInfo.isNewUser, isFalse);
      ...
      test('should create a user with an email and password', () async {
        ...
        await FirebaseAuth.instance
          ...
          .then((newUserCredential) async {
            ...
            expect(
              additionalUserInfo.isNewUser, isTrue);
    ...
    group('fetchSignInMethodsForEmail()', () {
      test('should return password provider for an email address', () async {
        ...
        expect(
          providers, isList);
        expect(
          providers.contains('password'), isTrue);
      });
    ...
    group('setPersistence()', () {
      test('throw an unimplemented error', () async {
        try {
          ...
          expect(
            e,
            isInstanceOf<UnimplementedError>());
        }
      },
      skip: kIsWeb);
    ...
    group('signOut()', () {
      test('should sign out', () async {
        ...
        expect(
          FirebaseAuth.instance.currentUser, isNull);
      });
    });
