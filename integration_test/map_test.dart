...
void main() {
  ...
  testWidgets('testCompassToggle', (tester) async {
      ...
      Directionality(
        ...
        child: GoogleMap(
          ...
          onMapCreated: (controller) {
            inspectorCompleter.complete(
              MapInspector(controller.channel));
          },
        ),
      ));
  ...
  testWidgets('testMapToolbarToggle', (tester) async {
    final Key key = GlobalKey();
    final Completer<MapInspector> inspectorCompleter = Completer<MapInspector>();
  ...
  testWidgets('updateMinMaxZoomLevels', (tester) async {
    ...
    if ( Platform.isIOS ) {
      ...
      expect(
        zoomLevel,
        equals(initialZoomLevel.minZoom));
    }
    ...
    if ( Platform.isIOS ) {
      ...
      expect(
        zoomLevel,
        equals(finalZoomLevel.minZoom));
    }
  });

  testWidgets('testZoomGesturesEnabled', (tester) async {
    final Key key = GlobalKey();
    final Completer<MapInspector> inspectorCompleter = Completer<MapInspector>();
  ...
  testWidgets('testZoomControlsEnabled', (tester) async {
    final Key key = GlobalKey();
    final Completer<MapInspector> inspectorCompleter = Completer<MapInspector>();
  ...
  testWidgets('testLiteModeEnabled', (tester) async {
    final Key key = GlobalKey();
    final Completer<MapInspector> inspectorCompleter = Completer<MapInspector>();
  ...
  testWidgets('testRotateGesturesEnabled', (tester) async {
    final Key key = GlobalKey();
    final Completer<MapInspector> inspectorCompleter = Completer<MapInspector>();
  ...
  testWidgets('testTiltGesturesEnabled', (tester) async {
    final Key key = GlobalKey();
    final Completer<MapInspector> inspectorCompleter = Completer<MapInspector>();
  ...
  testWidgets('testScrollGesturesEnabled', (tester) async {
    final Key key = GlobalKey();
    final Completer<MapInspector> inspectorCompleter =
        Completer<MapInspector>();
  ...
  testWidgets('testInitialCenterLocationAtCenter', (tester) async {
    ...
    if ( Platform.isIOS ) {
      ...
      expect(
        coordinate.x,
        (rect.center.dx - rect.topLeft.dx).round());
      expect(
        coordinate.y,
        (rect.center.dy - rect.topLeft.dy).round());
    } else {
      expect(
        coordinate.x,
  ...
  testWidgets('testGetVisibleRegion', (tester) async {
    final Key key = GlobalKey();
    final Completer<GoogleMapController> mapControllerCompleter =
        Completer<GoogleMapController>();
    ...
    expect(
      firstVisibleRegion, isNotNull);
    expect(
      firstVisibleRegion.southwest, isNotNull);
    expect(
      firstVisibleRegion.northeast, isNotNull);
    expect(
      firstVisibleRegion,
      isNot(zeroLatLngBounds));
    expect(
      firstVisibleRegion.contains(_kInitialMapCenter), isTrue);
    ...
    expect(
      firstVisibleRegion.contains(northEast), isFalse);
    expect(
      firstVisibleRegion.contains(southWest), isFalse);
    ...
    expect(
      secondVisibleRegion, isNotNull);
    expect(
      secondVisibleRegion.southwest, isNotNull);
    expect(
      secondVisibleRegion.northeast, isNotNull);
    expect(
      secondVisibleRegion,
      isNot(zeroLatLngBounds));
    ...
    expect(
      firstVisibleRegion,
      isNot(secondVisibleRegion));
    expect(
      secondVisibleRegion.contains(newCenter), isTrue);
  });

  testWidgets('testTraffic', (tester) async {
    final Key key = GlobalKey();
    final Completer<MapInspector> inspectorCompleter = Completer<MapInspector>();
  ...
  testWidgets('testBuildings', (tester) async {
    final Key key = GlobalKey();
    final Completer<MapInspector> inspectorCompleter = Completer<MapInspector>();
  ...
  testWidgets('testMyLocationButtonToggle', (tester) async {
    final Key key = GlobalKey();
    final Completer<MapInspector> inspectorCompleter = Completer<MapInspector>();
  ...
  testWidgets('testMyLocationButton initial value false', (tester) async {
    final Key key = GlobalKey();
    final Completer<MapInspector> inspectorCompleter = Completer<MapInspector>();
  ...
  testWidgets('testMyLocationButton initial value true', (tester) async {
    final Key key = GlobalKey();
    final Completer<MapInspector> inspectorCompleter = Completer<MapInspector>();
  ...
  testWidgets('testSetMapStyle valid Json String', (tester) async {
    final Key key = GlobalKey();
  ...
  testWidgets('testSetMapStyle invalid Json String', (tester) async {
    final Key key = GlobalKey();
    final Completer<GoogleMapController> controllerCompleter =
        Completer<GoogleMapController>();
  ...
  testWidgets('testSetMapStyle null string', (tester) async {
    final Key key = GlobalKey();
    final Completer<GoogleMapController> controllerCompleter =
        Completer<GoogleMapController>();
  ...
  testWidgets('testGetLatLng', (tester) async {
    final Key key = GlobalKey();
    final Completer<GoogleMapController> controllerCompleter =
        Completer<GoogleMapController>();
  ...
  testWidgets('testGetZoomLevel', (tester) async {
    final Key key = GlobalKey();
    final Completer<GoogleMapController> controllerCompleter =
        Completer<GoogleMapController>();
  ...
  testWidgets('testScreenCoordinate', (tester) async {
    final Key key = GlobalKey();
    final Completer<GoogleMapController> controllerCompleter =
        Completer<GoogleMapController>();
  ...
  testWidgets('testResizeWidget', (tester) async {
    final Completer<GoogleMapController> controllerCompleter =
        Completer<GoogleMapController>();
  ...
  testWidgets('testToggleInfoWindow', (tester) async {
  ...
  testWidgets("fromAssetImage", (tester) async {
    ...
    final BitmapDescriptor scaled = await BitmapDescriptor.fromAssetImage(
        ...
        mipmaps: false);
    expect(
      (mip.toJson() as List<dynamic>)[2], 1);
    expect(
      (scaled.toJson() as List<dynamic>)[2], 2);
  });

  testWidgets('testTakeSnapshot', (tester) async {
    final Completer<MapInspector> inspectorCompleter = Completer<MapInspector>();
  ...
  testWidgets(
    'set tileOverlay correctly', (tester) async {
      final Completer<MapInspector> inspectorCompleter = Completer<MapInspector>();
      ...
      expect(
        tileOverlayInfo1['fadeIn'], isTrue);
      expect(
        tileOverlayInfo1['transparency'],
        moreOrLessEquals(0.2, epsilon: 0.001));
      expect(
        tileOverlayInfo1['zIndex'], 2);

      expect(
        tileOverlayInfo2['visible'], isFalse);
      expect(
        tileOverlayInfo2['fadeIn'], isFalse);
      expect(
        tileOverlayInfo2['transparency'],
        moreOrLessEquals(0.3, epsilon: 0.001));
      expect(
        tileOverlayInfo2['zIndex'], 1);
    },
  );

  testWidgets(
    'update tileOverlays correctly', (tester) async {
      final Key key = GlobalKey();
      final Completer<MapInspector> inspectorCompleter = Completer<MapInspector>();
      ...
      expect(
        tileOverlayInfo1['visible'], isFalse);
      expect(
        tileOverlayInfo1['fadeIn'], isFalse);
      expect(
        tileOverlayInfo1['transparency'],
        moreOrLessEquals(0.3, epsilon: 0.001));
      expect(
        tileOverlayInfo1['zIndex'], 1);

      expect(
        tileOverlayInfo2, isNull);
    },
  );

  testWidgets(
    'remove tileOverlays correctly', (tester) async {
      final Key key = GlobalKey();
      final Completer<MapInspector> inspectorCompleter = Completer<MapInspector>();
...
class _DebugTileProvider implements TileProvider {
  ...
  Future<Tile> getTile(int x, int y, int? zoom) async {
    ...
    final Uint8List byteData = await recorder
      .endRecording()
